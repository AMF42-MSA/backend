...
public class PolicyHandler {
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void wheneverLectureRegistered_displayOnTheStore(@Payload LectureRegistered lectureRegistered) {
        ...
        lectRegist.setLectureStatus(lectureRegistered.getLectStatus());
